var PORTAL = (function (PORTAL, $) {
    ...
    PORTAL.modules.ProductList.init = function ($self) {
        ...
        var pagginationDraw = function () {
            ...
            var $pagginationBackIMG = $("<img src='/content/dam/wedding/catalog/back.png' />").click(function () {
                loadPreviusPage();
            });
            var $pagginationForwardIMG = $("<img src='/content/dam/wedding/catalog/forward.png' />").click(function () {
                loadNextPage();
            });
        ...
        var changeCountOfProducts = function (count) {
            $countOfProducts.text("Всего: " + count + " обьявлений");
        };
