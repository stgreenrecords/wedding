            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    /*  if ( data ){
                            ...
                            var example_object = JSON.parse(example_object_json);*/
                    ...
                    /* document.querySelector(".search-usually");
                      first_div.querySelector(".search-usually_content_name").innerHTML = photo_first_five[4].firstName + " "+ photo_first_five[4].lastName ; */
                ...
                $.ajax({  // ---  AJAX 2
                        ...
                        success: function (data) {
                         ...
                         // var copy_div = second_div.cloneNode(true);
